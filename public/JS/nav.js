    ...
    constructor() {
        ...
        `
            <nav id="main-nav" class="main-nav-b">
                ...
                <div class="dropdown">
                    <p class="dpd-s prog"><a href="../../404.html" tabindex="5">Programming</a></p>
                    <hr/ class="dpd-sep">
                    <p class="dpd-s dis"><a href="../design/design.html" tabindex="6">Disain</a></p>
                </div>

                <div class="navbar">
                    <ul class="logo">
                        <li class="l-top"><a href="../inti/index.html" tabindex="1">SPILL</a></li>
                        <!--<li class="l-btm">Design Division</li>-->
                    </ul>
                    <ul class="link">
                        <li><a class="home" href="../inti/index.html" tabindex="2">Home</a></li>
                        <li><a class="about" href="../inti/about.html" tabindex="3">About</a></li>
                        ...
                        <li><a class="blog" href="../../404.html" tabindex="7">Blog</a></li>
                    </ul>
